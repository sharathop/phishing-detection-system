...
- 🌐 Application: http://3.7.71.109
- 📖 API Documentation (Swagger): http://3.7.71.109/docs
...
Nginx is configured as a reverse proxy to forward HTTP traffic to the FastAPI application.
